	...
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group">
				<label for="persona-personaDni">DNI</label>
				<input class="form-control input-sm" type="text" name="persona-personaDni" id="persona-personaDni" value="<%=persona.personaDni%>" />
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-6">
			<div class="form-group">
				<label for="persona-personaApaterno">Apellido Paterno</label>
		...
		<div class="col-sm-6">
			<div class="form-group">
				<label for="persona-personaAmaterno">Apellido Materno</label>
